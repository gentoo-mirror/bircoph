...
src_prepare() {
	epatch \
		"${FILESDIR}"/${PN}-5.28.00-prop-ldflags.patch \
		"${FILESDIR}"/${P}-configure-paths.patch \
		"${FILESDIR}"/${PN}-5.28.00-asneeded.patch \
		"${FILESDIR}"/${PN}-5.28.00-nobyte-compile.patch \
		"${FILESDIR}"/${PN}-5.28.00-glibc212.patch \
		"${FILESDIR}"/${P}-xrootd-prop-flags.patch \
		"${FILESDIR}"/${PN}-5.28.00-unuran.patch
