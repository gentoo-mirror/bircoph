...
src_prepare() {
	...
	epatch "${FILESDIR}"/openafs-1.6.2-kernel-3.8-1.patch
	epatch "${FILESDIR}"/openafs-1.6.2-kernel-3.8-2.patch
	epatch "${FILESDIR}"/openafs-1.6.2-kernel-3.8-3.patch
	epatch "${FILESDIR}"/openafs-1.6.2-kernel-3.8-4.patch
	epatch "${FILESDIR}"/openafs-1.6.2-kernel-3.8-5.patch
