...
# $Header: /var/cvsroot/gentoo-x86/media-libs/mesa/mesa-8.0.2.ebuild,v 1.5 2012/05/11 00:45:56 chithanh Exp $
...
src_prepare() {
	...
	# fix build with llvm-3.1, bug 417363
	epatch "${FILESDIR}/${P}-llvm.patch"
